...
export default async () => {
    ...
    console.log(chalk.cyan("⚡️ Spark Theme Dev is ready and waiting for changes...\n"));
    chokidar
        ...
        if (basename(filePath) === "theme.css") {
            ...
            try {
                await client.updateCss(config.theme_id, fs.readFileSync(filePath, "utf8"));
        ...
        if (basename(filePath) === "layout.html") {
            ...
            try {
                await client.updateLayout(config.theme_id, fs.readFileSync(filePath, "utf8"));
